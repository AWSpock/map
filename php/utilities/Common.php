...
{
    if (file_exists("/var/www/map" . $file)) {
        $v = filemtime("/var/www/map" . $file);
        echo "<link rel='stylesheet' type='text/css' href='//map.spockfamily.net" . $file . "?v=" . $v . "' />\n";
    }
}
function IncludeJS($file)
{
    if (file_exists("/var/www/map" . $file)) {
        $v = filemtime("/var/www/map" . $file);
        echo "<script src='//map.spockfamily.net" . $file . "?v=" . $v . "'></script>\n";
    }
}
