...
class Location
{
    ...
    public static function fromPost($post)
    {
        ...
        $rec1['date'] = $post['location_date'];
        $rec1['odometer'] = $post['location_odometer'];
        $rec1['price'] = $post['location_price'];
        $rec1['description'] = $post['location_description'];
        $rec1['garage'] = $post['location_garage'];
        $new = new static($rec1);
        return $new;
    }
