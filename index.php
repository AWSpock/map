...
include_once("/var/www/map/php/utilities/Common.php");
include_once("/var/www/map/php/utilities/RouteParser.php");

include_once("/var/www/map/php/DataAccess/UserAuth.php");
include_once("/var/www/map/php/DataAccess/DataAccess.php");
...
switch ($routeParser->ResourcePath()) {
    ...
    default:
        ...
        if (array_key_exists(4, $uriparts))
            $location_id = explode("/", $_SERVER['REQUEST_URI'])[4];
        break;
}
